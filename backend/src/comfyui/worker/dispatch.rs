...
use super::status::{handle_failure, mark_completed};
...
struct PendingTask {
    ...
    /// The workflow's name and stored contract, so a stage handed something it
    /// cannot read can say which stage and what it wanted.
